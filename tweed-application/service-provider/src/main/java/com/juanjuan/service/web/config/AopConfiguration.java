package com.juanjuan.service.web.config;
...
public class AopConfiguration {
    ...
    @Around("@annotation(com.juanjuan.service.web.annotation.Limited)")
    ...
    @Around("@annotation(com.juanjuan.service.web.annotation.Timeout)")
